package com.example.reportflow.app
...
import com.example.reportflow.login.LoginPassword
import com.example.reportflow.http.endpoints.PersonEndpoint
import com.example.reportflow.domain.UserToken
  ...
  def apply(): HtmlElement =
    div(
      ShellBar(
        ...
        _.primaryTitle       := "reportflow",
        _.secondaryTitle     := "Great reportflow",
