package com.example.reportflow.http
...
import com.example.reportflow.service.*
import com.example.reportflow.http.prometheus.*
import com.example.reportflow.services.*
import com.example.reportflow.repositories.*
  ...
  private val server =
    for {
      ...
      docEndpoints = SwaggerInterpreter()
                       .fromServerEndpoints(apiEndpoints, "reportflow", "1.0.0")
      _ <- Server.serve(
             Routes(
